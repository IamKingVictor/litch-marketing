...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-20 flex items-center gap-5 border-b bg-background/95 px-4 py-3 backdrop-blur md:px-10">
      <div className="mx-auto flex w-full max-w-[1400px] items-center gap-5">
        ...
        <div className="ml-auto flex items-center gap-4 text-primary">
          ...
          <Link href="/cart" aria-label="Cart" className="relative">
            ...
            {cartCount > 0 && (
              <span className="absolute -right-2 -top-2 flex size-4 items-center justify-center rounded-full bg-gold text-[10px] font-bold text-white">
                {cartCount}
              </span>
            )}
          </Link>
