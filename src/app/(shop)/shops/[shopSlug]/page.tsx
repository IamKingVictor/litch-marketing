...
// This dynamic route intentionally makes /shops/parallex-bank reachable by
// direct URL without adding Parallex Bank to the public directory links.
...
export default async function ShopDetailPage({
  ...
  return (
    <main className="mx-auto max-w-6xl px-4 py-8 md:px-10">
      ...
      />
      <Breadcrumbs
        crumbs={[{ label: "Shops", href: "/shops" }, { label: shop.name }]}
      />
